...
export default function NavBar() {
  ...
  return (
    <div className="relative flex sm:justify-center sm:items-center px-2 sm:px-8 sm:py-0 pt-[11px] pb-[22px] h-[84px] sm:h-[72px] transition-colors duration-300">
      ...
      <div className="hidden left-8 absolute sm:flex justify-center items-center bg-black dark:bg-white rounded-full w-[38px] h-[38px] transition-colors duration-300">
        <span className="font-sans font-extrabold text-[18px] text-white dark:text-[#13172A] transition-colors duration-300">
          N
        </span>
      </div>
          ...
          return (
            ...
            >
              {isActive && (
                <>
                  {/* Mobile indicator */}
                  <span className="sm:hidden -top-[12px] absolute bg-primary rounded-full w-[22px] h-[3px] transition-all duration-300"></span>
                  {/* Desktop indicator */}
                  <span className="hidden sm:block top-0 absolute bg-primary w-[32px] h-[3px] transition-all duration-300"></span>
                </>
              )}
              {tab.icon}
              <span
